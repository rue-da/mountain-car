...
class TD3Agent(BaseAgent):
    """TD3 via SB3 — continuous action spaces only (continuous_steps / continuous_fuel)."""

    def __init__(self, env, lr=1e-3, gamma=0.99, buffer_size=100_000,
    ...
    def load(cls, path, env):
        ...
        agent.model = SB3TD3.load(path, env=env)
        agent.step_count = 0
